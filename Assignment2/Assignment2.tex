...
% \end{enumerate}
\subsection{Solution}
\item Let the $T_1$ and $T_2$ be coordinates trisecting the line AB
\begin{align}
\vec{T}_1 &=\frac{\vec{B} + 2\vec{A}}{3}\label{eq5}
\\\vec{T}_2 &=\frac{2\vec{B} + \vec{A}}{3}\label{eq6}
\end{align}
Let $\vec{A}=\myvec{1\\-2}, \vec{B}=\myvec{-3\\4}$\\
From \eqref{eq5}
\begin{align}
\vec{T}_1&=\frac{\myvec{-3\\4}+2\myvec{1\\-2}}{3}\\
&=\frac{{\myvec{-3\\4}+\myvec{2\\-4}}}{3}\\
\vec{T}_1&=\myvec{\frac{-1}{3}\\0}=\myvec{-0.33\\0}
\end{align}
From \eqref{eq6}
\begin{align}
\vec{T}_2&=\frac{2\myvec{-3\\4}+\myvec{1\\-2}}{3}\\
&=\frac{\myvec{-6\\8}+\myvec{1\\-2}}{3}\\
\vec{T}_2&=\myvec{\frac{-5}{3}\\2}=\myvec{-1.66\\2}
\end{align}
\begin{figure}[!ht]
\includegraphics[width=\columnwidth]{Assignement2.png}
\caption{}
